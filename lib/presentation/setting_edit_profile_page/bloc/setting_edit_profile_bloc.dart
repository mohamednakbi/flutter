import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:mohamed_s_application1/presentation/setting_edit_profile_page/models/setting_edit_profile_model.dart';import 'package:mohamed_s_application1/data/models/me/get_me_resp.dart';import 'dart:async';import 'package:mohamed_s_application1/data/repository/repository.dart';import 'package:fluttertoast/fluttertoast.dart';part 'setting_edit_profile_event.dart';part 'setting_edit_profile_state.dart';class SettingEditProfileBloc extends Bloc<SettingEditProfileEvent, SettingEditProfileState> {SettingEditProfileBloc(SettingEditProfileState initialState) : super(initialState) { on<SettingEditProfileInitialEvent>(_onInitialize); on<ChangeDropDownEvent>(_changeDropDown);on<FetchMeEvent>(_callFetchMe); }
